class Main {
  ...
  __scrollInit() {
    ...
    this._observers = new ScrollObserver('.swiper-container' ,this._toggleSwiper.bind(this));
    this._observers = new ScrollObserver('#main-content' ,this._sideAnimation.bind(this),{ones: false, rootMargin: "-300px 0px"});
  }
}
